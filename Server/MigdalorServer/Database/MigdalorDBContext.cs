...
namespace MigdalorServer.Database
{
    public partial class MigdalorDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.InterestName).HasName("PK__OH_Inter__F70EB38A53F5F22F");
            });
            ...
            modelBuilder.Entity<OhNotice>(entity =>
            {
                ...
                entity
                    .HasOne(d => d.NoticeCategoryNavigation)
            ...
            {
                entity.HasKey(e => e.HourId).HasName("PK__OH_Openi__18DFA33E19AE9D5C");
            ...
            modelBuilder.Entity<OhPerson>(entity =>
            {
                ...
                entity
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("PersonId", "PermissionName")
                                .HasName("PK__OH_Perso__2B7B1C825C7E3668");
            ...
            {
                entity.HasKey(e => e.PersonId).HasName("PK__OH_Priva__AA2FFB85842960B8");
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        l =>
                            l.HasOne<OhInterest>()
                                ...
                                .HasConstraintName("FK_ResidentsInterests_Interests"),
                        r =>
                            r.HasOne<OhResident>()
                                .WithMany()
                                .HasForeignKey("ResidentId")
                                .HasConstraintName("FK_ResidentsInterests_Residents"),
                        j =>
                        {
                            ...
                            j.IndexerProperty<string>("InterestName")
                                .HasMaxLength(50)
            ...
            {
                entity
                    .HasKey(e => new { e.RoomNumber, e.BuildingNumber })
                    .HasName("PK__OH_Rooms__CD87FECFF4277B52");
            });

            modelBuilder.Entity<OhScheduleOverride>(entity =>
            {
                entity.HasKey(e => e.OverrideId).HasName("PK__OH_Sched__37B513C43B88609F");
            ...
            {
                entity.HasKey(e => e.ServiceId).HasName("PK__OH_Servi__C51BB0EAD92A1A44");
            ...
            modelBuilder.Entity<OhUserSetting>(entity =>
            {
                ...
                entity
                    .Property(e => e.UserSelectedDirection)
