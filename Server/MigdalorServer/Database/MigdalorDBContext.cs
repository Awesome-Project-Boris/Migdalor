...
namespace MigdalorServer.Database
{
    public partial class MigdalorDBContext : DbContext
    {
        ...
        public virtual DbSet<OhInterestCategory> OhInterestCategories { get; set; } = null!;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OhInterest>(entity =>
            {
                entity.HasKey(e => e.InterestId)
                    .HasName("PK__OH_Inter__3EA937197E610CD9");

                entity.HasOne(d => d.CategoryNavigation)
                    .WithMany(p => p.OhInterests)
                    .HasForeignKey(d => d.Category)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__OH_Intere__categ__11158940");
            });

            modelBuilder.Entity<OhInterestCategory>(entity =>
            {
                entity.HasKey(e => e.CategoryId)
                    .HasName("PK__OH_Inter__23CAF1F84CC26BE7");
            });
            ...
            {
                entity.HasKey(e => new { e.ActivityId, e.ParticipantId, e.ParticipationDate })
                    .HasName("PK__OH_Parti__172E5FA03E34F7FF");
