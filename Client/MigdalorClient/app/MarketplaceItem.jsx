...
export default function MarketplaceItemScreen() {
  ...
  const handleContactPress = (type) => {
    ...
    if (!url || !contactValue) { // Check if a valid action could be determined
  ...
  if (!listingDetails) { /* ... No details state ... */
