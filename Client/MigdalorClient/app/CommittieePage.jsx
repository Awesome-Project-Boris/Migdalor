...
const fetchCommitteeMembersAPI = async () => {
  ...
  const mockMembers = [
    { memberId: 'c1', name: 'Alice Chairman', title: 'Committee Chair', photoUrl: 'https://i.pravatar.cc/300?u=com1' },
    { memberId: 'c2', name: 'Bob Treasurer', title: 'Treasurer', photoUrl: 'https://i.pravatar.cc/300?u=com2' },
    { memberId: 'c3', name: 'Charlie Secretary', title: 'Secretary', photoUrl: 'https://i.pravatar.cc/300?u=com3' },
    { memberId: 'c4', name: 'Diana Member', title: 'Member at Large', photoUrl: 'https://i.pravatar.cc/300?u=com4' },
    { memberId: 'c5', name: 'Ethan Representative', title: 'Community Rep', photoUrl: 'https://i.pravatar.cc/300?u=com5' },
  ];
  return mockMembers;
};
// --- End Mock API ---
      ...
      <FlatList
          ListHeaderComponent={
              <>
                  ...
                  {!isLoading && committeeMembers.length > 0 && <View style={styles.listStartSeparator} />}
              </>
          }
